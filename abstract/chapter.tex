...
The positioning algorithms I introduce, \define{\BRP} (\aBRP) and an orientation aware version \aBRP-O, perform slightly worse, but a combination of \aBRP-O with SSD-O brings the 95th percentile error down to 2.40m.
