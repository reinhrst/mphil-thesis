...
A second, more serious, way in which privacy can be lost is if two positinings done (either in short succession or days apart) can be determined to be from the same \device; if not I determine the method to be \cat{untrackable}.
